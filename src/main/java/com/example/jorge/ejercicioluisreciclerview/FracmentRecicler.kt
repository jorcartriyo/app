 ...
 * [FracmentRecicler.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [FracmentRecicler.newInstance] factory method to
 * create an instance of this fragment.
 *
 */
class FracmentRecicler : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        adaptera= DatosAdapter(datos, context!! )
